...
export const INITIAL_PRODUCTS: Product[] = [
  {
    ...
    description:
      'Constructed from custom-milled 280 GSM interlock combed cotton. Designed with an exaggerated boxy drape, reinforced ribbed collar, and minimal clean lines that hold their architectural silhouette after countless washes.',
    details: [
    ...
    reviews: [
      {
        ...
        comment:
          'The collar does not bacon at all. The 280 GSM drape is stiff in the best architectural way. Truly comparable to $200 luxury streetwear brands.',
        verified: true,
        sizePurchased: 'L',
      },
      {
        ...
        comment:
          'Drop shoulder proportion is dialed in accurately. Usually streetwear tees look messy, but this looks extremely sharp and elevated.',
        verified: true,
        sizePurchased: 'M',
      },
    ],
...

  {
    ...
    description:
      'An uncompromising 450 GSM pure French Terry hoodie engineered with double-layered hood without drawstrings for a pure minimalist neckline. Custom raw edge rib hem and articulated sleeves create a relaxed structural drape.',
    details: [
...

  {
    ...
    description:
      'A structural statement shirt tailored with clean concealed placket, dropped shoulders, and a wide rear box pleat. Bridges high-tailoring with contemporary streetwear ease.',
    details: [
...

  {
    ...
    description:
      'Each garment undergoes an artisan stone and mineral wash process, giving it subtle high-low contrast along the seams and a buttery-soft broken-in hand feel.',
    details: [
...

  {
    ...
    description:
      'A heavy zip pullover engineered for cool urban evenings. Features custom muted champagne-gold two-way zipper hardware and dense cotton fleece interior.',
    details: [
...

  {
    ...
    description:
      'Designed to pool effortlessly over chunky sneakers or dress shoes. Features deep double front pleats, hidden elastic waistband insert, and an elegant fluid drape.',
    details: [
...

  {
    ...
    description:
      'Engineered for effortless layered styling. Features a relaxed retro Cuban camp collar, clean flat hem, and breathable cotton-linen blend fabric.',
    details: [
...

  {
    ...
    description:
      'Essential transitional layering piece. Extended sleeves gather softly at wrists with ribbed cuffs and subtle raw edge neckline detailing.',
    details: [
